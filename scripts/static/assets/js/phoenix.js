(function (global, factory) {
    ...
    const reportsDetailsChartInit = () => {
        const {getColor: t, getData: o, toggleColor: e} = window.phoenix.utils,
            i = document.querySelector(".echart-reports-details"), r = (t, o = "MMM DD") => {
                let e = "";
                return t.forEach((t => {
        ...
        if (i) {
            const l = o(i, "echarts"), n = window.echarts.init(i);
            echartSetOption(n, l, (() => ({
        ...
        if (window.List) {
            ...
            t.length && t.forEach((t => {
                ...
                const i = t.querySelector('[data-list-pagination="next"]'),
                    ...
                    r = t.querySelector("[data-list-filter]"), g = new List(t, n);
    ...
    const themeControl = () => {
        const {getData: e, getItemFromStore: t, getSystemTheme: a} = window.phoenix.utils, o = t => {
                const a = e(t, "page-url");
                a ? window.location.replace(a) : window.location.reload();
            }, n = new DomNode(document.body), r = document.querySelector(".navbar-vertical"),
            i = document.querySelector(".navbar-top"), c = document.querySelector(".support-chat-container");
