(function (factory) {
    ...
    const newCustomersChartsInit = () => {
        const {getColor: o, getData: t, getDates: e} = window.phoenix.utils,
            a = document.querySelector(".echarts-new-customers"), i = o => {
        ...
        if (a) {
            const r = t(a, "echarts"), s = window.echarts.init(a);
            echartSetOption(s, r, (() => ({
                tooltip: {
                    trigger: "axis",
                    padding: 10,
    ...
    const projectionVsActualChartInit = () => {
        const {getColor: t, getData: o, getPastDates: e} = window.phoenix.utils,
            i = document.querySelector(".echart-projection-actual"), r = e(10),
        ...
        if (i) {
            const e = o(i, "echarts"), l = window.echarts.init(i);
            echartSetOption(l, e, (() => ({
                ...
                series: [{
                    ...
                    label: {show: !1},
                    z: 10,
                    itemStyle: {borderRadius: [2, 2, 0, 0], color: t("info-bg-subtle")}
                }],
    ...
    const totalOrdersChartInit = () => {
        ...
        if (e) {
            const a = t(e, "echarts"), i = window.echarts.init(e);
            echartSetOption(i, a, (() => ({
                color: o("primary"),
                tooltip: {
                    trigger: "item",
                ...
                series: [{
                    ...
                    backgroundStyle: {borderRadius: 10, color: o("primary-bg-subtle")}
                }],
    ...
    const totalSalesChartInit = () => {
        ...
        if (a) {
            const e = t(a, "echarts"), l = window.echarts.init(a);
            echartSetOption(l, e, (() => ({
                ...
                xAxis: [{
                    ...
                    splitLine: {
                        show: !0,
                        interval: 0,
                        lineStyle: {color: "dark" === window.config.config.phoenixTheme ? o("body-highlight-bg") : o("secondary-bg")}
                    },
                    boundaryGap: !1
                }, {
                    type: "category",
