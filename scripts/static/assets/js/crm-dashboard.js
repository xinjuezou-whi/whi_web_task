(function (factory) {
    ...
    const contactsBySourceChartInit = () => {
        const {getColor: e, getData: t, toggleColor: a} = window.phoenix.utils,
            ...
            r = o.querySelector(".echart-contact-by-source"), i = o.querySelector("[data-label]");
        if (r) {
            const o = t(r, "echarts"), n = window.echarts.init(r),
                l = [{value: 80, name: "Organic Search"}, {value: 65, name: "Paid Search"}, {
                    value: 40,
                    name: "Direct Traffic"
            ...
            i && (i.innerHTML = c);
            echartSetOption(n, o, (() => ({
                color: [e("primary"), e("success"), e("info"), a(e("info-light"), e("info-dark")), a(e("danger-lighter"), e("danger-darker")), a(e("warning-light"), e("warning-dark"))],
                tooltip: {trigger: "item", borderWidth: 0, position: (...e) => handleTooltipPosition(e)},
                responsive: !0,
    ...
    const contactsCreatedChartInit = () => {
        const {getColor: t, getData: o, getPastDates: e} = window.phoenix.utils,
            r = document.querySelector(".echart-contacts-created"), i = e(9), a = [24, 14, 30, 24, 32, 32, 18, 12, 32],
        ...
        if (r) {
            ...
            echartSetOption(l, e, (() => ({
                ...
                xAxis: {
                    ...
                    splitLine: {show: !0, interval: "10", lineStyle: {color: t("tertiary-bg")}},
                    show: !0,
                    interval: 10,
                    data: i,
                ...
                series: [{
                    ...
                    barWidth: "4px",
                    barGap: "3",
                    label: {show: !0, position: "top", color: t("body-color"), fontWeight: "bold", fontSize: "10.24px"},
                    z: 10,
                    itemStyle: {borderRadius: [2, 2, 0, 0], color: t("tertiary-bg")}
                }, {
    ...
    const addClicksChartInit = () => {
        const {getColor: o, getData: t, getPastDates: e, getItemFromStore: i} = window.phoenix.utils,
            a = document.querySelector(".echart-add-clicks-chart"), r = e(11),
            l = [2e3, 2250, 1070, 1200, 1e3, 1450, 3100, 2900, 1800, 1450, 1700],
            n = [1100, 1200, 2700, 1700, 2100, 2e3, 2300, 1200, 2600, 2900, 1900], s = o => {
                const t = window.dayjs(o[0].axisValue), e = window.dayjs(o[0].axisValue).subtract(1, "month"),
                    i = o.map(((o, i) => ({value: o.value, date: i > 0 ? e : t, color: o.color})));
                let a = "";
                return i.forEach(((o, t) => {
                    a += `<h6 class="fs-9 text-body-tertiary ${t > 0 && "mb-0"}"><span class="fas fa-circle me-2" style="color:${o.color}"></span>\n      ${o.date.format("MMM DD")} : ${o.value}\n    </h6>`;
                })), `<div class='ms-1'>\n              ${a}\n            </div>`
            };
        if (a) {
            const e = t(a, "echarts"), c = window.echarts.init(a);
            echartSetOption(c, e, (() => ({
                tooltip: {
                    trigger: "axis",
                    padding: 10,
                ...
                yAxis: {
                    ...
                    splitLine: {
                        show: !0,
                        lineStyle: {color: "dark" === i("phoenixTheme") ? o("body-highlight-bg") : o("secondary-bg")}
                    },
                    axisLine: {show: !1},
                    axisLabel: {
                        show: !0,
    ...
    const echartsLeadConversiontInit = () => {
        const {getColor: e, getData: r, getPastDates: i, toggleColor: o} = window.phoenix.utils,
            t = document.querySelector(".echart-lead-conversion"), a = i(4);
        if (t) {
            const i = r(t, "echarts"), l = echarts.init(t);
            echartSetOption(l, i, (() => ({
                ...
                yAxis: {
                    ...
                    axisLine: {show: !1},
                    axisLabel: {show: !0, align: "left", margin: 100, color: e("body-color")}
                },
                series: {
                    ...
                    data: [{
                        value: 1060,
                        itemStyle: {color: o(e("success-lighter"), e("success-dark")), borderRadius: [4, 0, 0, 4]},
                        emphasis: {
                            itemStyle: {color: o(e("success-light"), e("success-dark"))},
                        ...
                        value: 1200,
                        itemStyle: {color: o(e("info-lighter"), e("info-dark")), borderRadius: [4, 0, 0, 4]},
                        emphasis: {
                        ...
                        value: 1600,
                        itemStyle: {color: o(e("primary-lighter"), e("primary-dark")), borderRadius: [4, 0, 0, 4]},
                        emphasis: {
                            itemStyle: {color: o(e("primary-light"), e("primary-dark"))},
                        ...
                        value: 1800,
                        itemStyle: {color: o(e("warning-lighter"), e("warning-dark")), borderRadius: [4, 0, 0, 4]},
                        emphasis: {
                            itemStyle: {color: o(e("warning-light"), e("warning-dark"))},
                        ...
                        value: 2e3,
                        itemStyle: {color: o(e("danger-lighter"), e("danger-dark")), borderRadius: [4, 0, 0, 4]},
                        emphasis: {
                            itemStyle: {color: o(e("danger-light"), e("danger-dark"))},
                            label: {formatter: () => "{a|100%}", rich: {a: {color: e("white")}}}
                        },
                        label: {
                            show: !0,
                            position: "inside",
                            formatter: () => "{a|100%}",
                            rich: {a: {color: o(e("danger-dark"), e("danger-subtle")), fontWeight: 500}}
                        }
                    }],
                    barGap: "50%"
                },
    ...
    const echartsRevenueTargetInit = () => {
        const {getColor: e, getData: t} = window.phoenix.utils,
            o = document.querySelector(".echart-revenue-target-conversion"), a = [42e3, 35e3, 35e3, 4e4],
            r = [30644, 33644, 28644, 38644];
        if (o) {
            const i = t(o, "echarts"), n = window.echarts.init(o);
            echartSetOption(n, i, (() => ({
                color: [e("primary"), e("tertiary-bg")],
                tooltip: {
                    trigger: "axis",
                ...
                series: [{
                    ...
                    barGap: "-100%",
                    data: a,
                    itemStyle: {borderWidth: 4, color: e("secondary-bg"), borderColor: e("secondary-bg")}
                }, {
                    name: "Gained",
                    type: "bar",
                    emphasis: {disabled: !0},
                    ...
                    barWidth: "30px",
                    data: r,
                    itemStyle: {borderWidth: 4, color: e("primary-light"), borderColor: e("secondary-bg")}
                }],
