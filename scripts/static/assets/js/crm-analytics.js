(function (factory) {
    ...
    const emailCampaignReportsChartInit = () => {
        const {getColor: t, getData: e, toggleColor: r} = window.phoenix.utils,
            o = document.querySelector(".echart-email-campaign-report"), a = (t, e = "MMM DD") => {
                const r = t[1],
                    o = `<div class='ms-1'>\n          <h6 class="text-body-tertiary"><span class="fas fa-circle me-1 fs-10" style="color:${r.borderColor ? r.borderColor : r.color}"></span>\n            ${r.axisValue} : ${"object" == typeof r.value ? r.value[1] : r.value}\n          </h6>\n        </div>`;
                return `<div>\n              <p class='mb-2 text-body-tertiary'>\n                ${r.seriesName}\n              </p>\n              ${o}\n            </div>`
            }, i = [0, 1466, 966, 0];
        if (o) {
            const l = e(o, "echarts"), s = echarts.init(o);
            echartSetOption(s, l, (() => ({
                ...
                series: [{
                    ...
                    type: "bar",
                    stack: "Total",
                    itemStyle: {color: r(t("primary-lighter"), t("primary-darker"))},
                    data: [{value: 2832, itemStyle: {color: r(t("primary-light"), t("primary-dark"))}}, 1366, 500, 966],
                    label: {
                        show: !0,
                        position: "inside",
    ...
    const socialMarketingRadarChartInit = () => {
        const {getColor: e, getData: a, rgbaColor: r, toggleColor: t} = window.phoenix.utils,
            o = document.querySelector(".echart-social-marketing-radar");
        if (o) {
            const i = a(o, "echarts"), l = echarts.init(o);
            echartSetOption(l, i, (() => ({
                ...
                tooltip: {
                    ...
                    textStyle: {color: e("body-color"), fontSize: 12.8, fontFamily: "Nunito Sans"},
                    borderWidth: 1,
                    transitionDuration: 0
                },
                radar: {
                    ...
                    name: {textStyle: {color: e("tertiary-color"), fontWeight: 800, fontSize: 10.2}},
                ...
                series: [{
                    ...
                    data: [{
                        ...
                        areaStyle: {color: r(e("primary-light"), .3)}
                    }, {
                        value: [3e3, 1600, 3700, 500, 3700, 3e3, 3200],
                        name: "Online Marketing",
                        areaStyle: {color: r(e("warning-light"), .3)},
    ...
    const salesTrendsChartInit = () => {
        const {getColor: t, getData: e, getPastDates: o, rgbaColor: i, toggleColor: r} = window.phoenix.utils,
            a = document.querySelector(".echart-sales-trends"), l = (t, e = "MMM DD") => {
                let o = "";
                return t.forEach((t => {
            ...
            }, n = o(7), s = [2e3, 5700, 3700, 5500, 8e3, 4e3, 5500], d = [10500, 9e3, 7e3, 9e3, 10400, 7500, 9300];
        if (a) {
            const o = e(a, "echarts"), c = window.echarts.init(a);
            echartSetOption(c, o, (() => ({
                ...
                series: [{
                    ...
                    barWidth: "16px",
                    label: {show: !1},
                    itemStyle: {color: r(t("primary-lighter"), t("primary")), borderRadius: [4, 4, 0, 0]},
                    data: d
                }, {
                    name: "Profit",
                    type: "line",
                    ...
                    areaStyle: {
                        color: {
                            ...
                            x2: 0,
                            y2: 1,
                            colorStops: [{offset: 0, color: i(t("info-light"), .2)}, {
                                offset: 1,
    ...
    const callCampaignChartInit = () => {
        const {getColor: o, getData: a, getPastDates: t, rgbaColor: e} = window.phoenix.utils,
            i = document.querySelector(".echart-call-campaign"), r = (o, a = "MMM DD") => {
                let t = "";
                return o.forEach((o => {
        ...
        if (i) {
            const t = a(i, "echarts"), s = window.echarts.init(i);
            echartSetOption(s, t, (() => ({
                ...
                series: [{
                    ...
                    areaStyle: {
                        color: {
                            ...
                            x2: 0,
                            y2: 1,
                            colorStops: [{offset: 0, color: e(o("primary-light"), .2)}, {
                                offset: 1,
