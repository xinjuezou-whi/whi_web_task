(function (factory) {
    ...
    const newCustomersChartsInit = () => {
        const {getColor: t, getData: o, getDates: a} = window.phoenix.utils,
            e = document.querySelector(".echarts-new-customers"), i = t => {
        ...
        if (e) {
            const r = o(e, "echarts"), s = window.echarts.init(e);
            echartSetOption(s, r, (() => ({
                tooltip: {
                    trigger: "axis",
                    padding: 10,
    ...
    const {echarts: echarts$3} = window, payingCustomerChartInit = () => {
        const {getData: t, getColor: e} = window.phoenix.utils,
            o = document.querySelector(".echarts-paying-customer-chart");
        if (o) {
            const r = t(o, "options"), i = echarts$3.init(o);
            echartSetOption(i, r, (() => ({
                tooltip: {
                    trigger: "item",
                    padding: [7, 10],
                ...
                series: [{
                    ...
                    pointer: {show: !1},
                    axisLine: {roundCap: !0, lineStyle: {width: 12, color: [[1, e("primary-100")]]}},
                    axisTick: {show: !1},
                    splitLine: {show: !1},
                    axisLabel: {show: !1},
                    title: {show: !1},
    ...
    const projectionVsActualChartInit = () => {
        const {getColor: t, getData: e, getPastDates: o} = window.phoenix.utils,
            a = document.querySelector(".echart-projection-actual"), r = o(10),
            i = [44485, 20428, 47302, 45180, 31034, 46358, 26581, 36628, 38219, 43256],
            n = [38911, 29452, 31894, 47876, 31302, 27731, 25490, 30355, 27176, 30393];
        if (a) {
            const o = e(a, "echarts"), l = echarts.init(a);
            echartSetOption(l, o, (() => ({
                ...
                legend: {
                    ...
                    textStyle: {color: t("gray-900"), fontWeight: 600, fontFamily: "Nunito Sans"}
                },
                xAxis: {
                    type: "category",
                    axisLabel: {
                ...
                series: [{
                    ...
                    label: {show: !1},
                    z: 10,
                    itemStyle: {borderRadius: [2, 2, 0, 0], color: t("info-100")}
                }],
    ...
    const leaftletPoints = [{
        ...
        street: "3742 Farland Avenue",
        location: "San Antonio"
    }, {lat: 46.716667, long: -79.099998, name: "299"}, {lat: 45.016666, long: -72.099998, name: "299"}];

    const {echarts: echarts$2} = window, returningCustomerChartInit = () => {
        const {getColor: t, getData: e} = window.phoenix.utils,
            o = document.querySelector(".echart-returning-customer");
        if (o) {
            const i = e(o, "echarts"), r = echarts$2.init(o);
            echartSetOption(r, i, (() => ({
                color: t("gray-100"),
                legend: {
                    data: [{
                        name: "Fourth time",
                        icon: "roundRect",
                        itemStyle: {color: t("primary-300"), borderWidth: 0}
                    }, {
                        name: "Third time",
                        icon: "roundRect",
                        itemStyle: {color: t("info-200"), borderWidth: 0}
                ...
                xAxis: {
                    ...
                    splitLine: {show: !0, lineStyle: {color: t("gray-200"), type: "dashed"}}
                },
                yAxis: {
                    type: "value",
                    boundaryGap: !1,
                ...
                series: [{
                    ...
                    lineStyle: {type: "dashed", width: 1, color: t("primary-300")},
                    itemStyle: {borderColor: t("primary-300"), borderWidth: 3}
                }, {
                    name: "Third time",
                    type: "line",
                    ...
                    itemStyle: {borderColor: t("info-200"), borderWidth: 3}
                }, {
                    name: "Second time",
                    type: "line",
    ...
    const totalOrdersChartInit = () => {
        const {getColor: t, getData: r, getDates: o} = window.phoenix.utils,
            a = document.querySelector(".echart-total-orders");
        if (a) {
            const e = r(a, "echarts"), i = window.echarts.init(a);
            echartSetOption(i, e, (() => ({
                color: t("primary"),
                tooltip: {
                    trigger: "item",
                ...
                series: [{
                    ...
                    backgroundStyle: {borderRadius: 10, color: t("primary-100")}
                }],
            ...
            echartSetOption(l, a, (() => ({
                ...
                xAxis: [{
                    ...
                    splitLine: {
                        show: !0,
                        interval: 0,
                        lineStyle: {color: "dark" === window.config.config.phoenixTheme ? t("gray-100") : t("gray-200")}
                    },
                    boundaryGap: !1
                }, {
                    type: "category",
    ...
    const {L: L} = window, leafletTopRegionsInit = () => {
    ...
    const revenueMapInit = () => {
        const e = document.body, t = document.querySelectorAll(".revenue-map");
        if (t.length && window.google) {
            ...
            t.forEach((t => {
                const l = t, s = {
                    ...
                    }, r = new window.google.maps.Map(l, s), a = new window.google.maps.InfoWindow,
