(function (factory) {
        ...
        if (t) {
            ...
            echartSetOption(a, i, (() => ({
                ...
                series: [{
                    ...
                    type: "line",
                    symbolSize: 10,
                    itemStyle: {color: o("body-highlight-bg"), borderColor: o("danger"), borderWidth: 2},
                    ...
                    type: "line",
                    symbolSize: 10,
                    itemStyle: {color: o("body-highlight-bg"), borderColor: o("primary"), borderWidth: 2},
    ...
    const stackedAreaChartInit = () => {
        ...
        if (r) {
            const a = e(r, "echarts"), l = window.echarts.init(r);
            echartSetOption(l, a, (() => ({
                tooltip: {
                    trigger: "axis",
                    padding: [7, 10],
    ...
    const lineMarkerChartInit = () => {
        ...
        if (o) {
            const t = r(o, "echarts"), i = window.echarts.init(o);
            echartSetOption(i, t, (() => ({
                color: [e("primary"), e("warning")],
                legend: {
                    data: [{name: "Max", textStyle: {color: e("quaternary-color")}}, {
                        name: "Min",
                ...
                xAxis: {
                    ...
                    axisTick: {show: !1},
                    axisLabel: {formatter: e => e.substring(0, 3), color: e("quaternary-color"), margin: 15},
                    splitLine: {show: !1}
                },
                yAxis: {
                    type: "value",
                ...
                series: [{
                    ...
                    data: [1, -2, 2, 5, 3, 2, 0],
                    symbolSize: 10,
                    itemStyle: {color: e("body-highlight-bg"), borderColor: e("danger"), borderWidth: 2},
        ...
        if (r) {
            ...
            echartSetOption(a, i, (() => ({
                ...
                visualMap: {
                    ...
                    dimension: 0,
                    seriesIndex: 0,
                    pieces: [{gt: 1, lt: 3, color: e(o("primary"), .4)}, {gt: 5, lt: 7, color: e(o("primary"), .4)}]
                },
                series: [{
                    type: "line",
                    name: "Total",
    ...
    const stepLineChartInit = () => {
        ...
        if (r) {
            const i = e(r, "echarts"), a = window.echarts.init(r);
            echartSetOption(a, i, (() => ({
                ...
                xAxis: {
                    ...
                    axisTick: {show: !1},
                    axisLabel: {formatter: t => t.substring(0, 3), color: t("quaternary-color"), margin: 15},
                    splitLine: {show: !1},
                ...
                series: [{
                    ...
                    step: "start",
                    symbolSize: 10,
                    itemStyle: {color: t("body-highlight-bg"), borderColor: t("primary"), borderWidth: 2},
                    ...
                    step: "middle",
                    symbolSize: 10,
                    itemStyle: {color: t("body-highlight-bg"), borderColor: t("warning"), borderWidth: 2},
                    ...
                    step: "end",
                    symbolSize: 10,
                    itemStyle: {color: t("body-highlight-bg"), borderColor: t("danger"), borderWidth: 2},
        ...
        if (o) {
            ...
            echartSetOption(n, r, (() => ({
                ...
                yAxis: {
                    type: "value",
                    axisLabel: {show: !0, color: t("quaternary-color"), margin: 15},
                    splitLine: {lineStyle: {color: t("secondary-bg"), type: "dashed"}}
                },
                grid: {right: "3%", left: "8%", bottom: "10%", top: "5%"},
                series: {
                    name: "Total",
    ...
    const lineLogChartInit = () => {
        ...
        if (t) {
            const r = e(t, "echarts"), i = window.echarts.init(t);
            echartSetOption(i, r, (() => ({
                tooltip: {
                    trigger: "axis",
                    padding: [7, 10],
        ...
        if (r) {
            ...
            echartSetOption(i, t, (() => ({
                ...
                series: [{
                    ...
                    emphasis: {focus: "series"},
                    symbolSize: 10,
                    itemStyle: {color: e("body-highlight-bg"), borderColor: e("info"), borderWidth: 2},
                    ...
                    emphasis: {focus: "series"},
                    symbolSize: 10,
                    itemStyle: {color: e("body-highlight-bg"), borderColor: e("warning"), borderWidth: 2},
                    ...
                    center: ["50%", "28%"],
                    emphasis: {focus: "data"},
                    label: {formatter: "{b}: {@2012} ({d}%)", color: e("tertiary-color")},
    ...
    const basicBarChartInit = () => {
        ...
        if (o) {
            const a = r(o, "echarts"), l = window.echarts.init(o);
            echartSetOption(l, a, (() => ({
                tooltip: {
                    trigger: "axis",
                    padding: [7, 10],
                ...
                xAxis: {
                    ...
                    axisLine: {lineStyle: {color: t("tertiary-bg"), type: "solid"}},
                    axisTick: {show: !1},
                    axisLabel: {color: t("quaternary-color"), formatter: t => t.substring(0, 3), margin: 15},
                    splitLine: {show: !1}
                },
                yAxis: {
                    type: "value",
    ...
    const horizontalBarChartInit = () => {
        const {getColor: t, getData: o} = window.phoenix.utils,
            ...
            a = [1020, 1160, 1300, 958, 1240, 1020, 1409, 1200, 1051, 1120, 1240, 1054];
        if (r) {
            const i = o(r, "echarts"), l = window.echarts.init(r);
            echartSetOption(l, i, (() => ({
                tooltip: {
                    trigger: "axis",
                    padding: [7, 10],
                ...
                yAxis: {
                    ...
                    data: e,
                    boundaryGap: !0,
                    axisLabel: {formatter: t => t.substring(0, 3), show: !0, color: t("quaternary-color"), margin: 15},
                    splitLine: {show: !0, lineStyle: {color: t("secondary-bg")}},
                    axisTick: {show: !1},
                    axisLine: {lineStyle: {color: t("tertiary-bg")}}
                },
    ...
    const barNegativeChartInit = () => {
        ...
        if (o) {
            const i = e(o, "echarts"), r = window.echarts.init(o);
            echartSetOption(r, i, (() => ({
                tooltip: {
                    trigger: "axis",
    ...
    const seriesBarChartInit = () => {
        ...
        if (r) {
            ...
            echartSetOption(i, o, (() => ({
                ...
                xAxis: {
                    type: "value",
                    axisLabel: {formatter: t => t / 1e3 + "k", color: t("quaternary-color")},
    ...
    const stackedBarChartInit = () => {
        const {getColor: t, getData: a, rgbaColor: o} = window.phoenix.utils,
            r = document.querySelector(".echart-stacked-bar-chart-example"), e = [], i = [], s = [], n = [], l = [];
        ...
        const c = {itemStyle: {shadowBlur: 10, shadowColor: o(t("light-text-emphasis"), .3)}};
        if (r) {
            const o = a(r, "echarts"), d = window.echarts.init(r);
            echartSetOption(d, o, (() => ({
                color: [t("primary"), t("info"), t("warning"), t("danger")],
                legend: {data: ["Bar1", "Bar2", "Bar3", "Bar4"], textStyle: {color: t("tertiary-color")}, left: 0},
                toolbox: {
                ...
                yAxis: {splitLine: {lineStyle: {color: t("secondary-bg")}}, axisLabel: {color: t("quaternary-color")}},
                series: [{name: "Bar1", type: "bar", stack: "one", emphasis: c, data: i}, {
                    name: "Bar2",
                    type: "bar",
                    stack: "one",
                    emphasis: c,
    ...
    const stackedHorizontalBarChartInit = () => {
        const {getColor: t, getData: e} = window.phoenix.utils,
            a = document.querySelector(".echart-stacked-horizontal-bar-chart-example"),
            o = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"];
        if (a) {
            const r = e(a, "echarts"), i = window.echarts.init(a);
            echartSetOption(i, r, (() => ({
                ...
                yAxis: {
                    ...
                    axisTick: {show: !1},
                    axisLabel: {color: t("quaternary-color"), formatter: t => t.substring(0, 3)}
                },
                series: [{
                    name: "Direct",
                    type: "bar",
    ...
    const barRaceChartInit = () => {
        ...
        if (r) {
            ...
            const n = () => {
                e = e.map((a => Math.random() > .9 ? a + Math.round(2e3 * Math.random()) : a + Math.round(200 * Math.random()))), i.setOption({series: [{data: e}]});
            };
            setTimeout((() => {
                n();
            }), 0), setInterval((() => {
    ...
    const barGradientChartInit = () => {
        const {getColor: t, getData: e} = window.phoenix.utils,
            ...
            r = [320, 190, 200, 210, 256, 451, 111, 150, 442, 321, 100, 451, 201, 232, 140, 124, 444, 333, 222, 111];
        if (a) {
            const i = e(a, "echarts"), n = window.echarts.init(a);
            echartSetOption(n, i, (() => ({
                tooltip: {
                    trigger: "axis",
                    padding: [7, 10],
    ...
    const barLineMixedChartInit = () => {
        ...
        if (t) {
            const a = o(t, "echarts"), i = window.echarts.init(t);
            echartSetOption(i, a, (() => ({
                tooltip: {
                    trigger: "axis",
                    axisPointer: {
                        ...
                        label: {show: !0, backgroundColor: e("tertiary-color"), color: e("body-highlight-bg")}
                    },
                    padding: [7, 10],
                    backgroundColor: e("body-highlight-bg"),
                    borderColor: e("border-color"),
                ...
                xAxis: [{
                    type: "category",
                    data: r,
                    axisLabel: {color: e("quaternary-color"), formatter: e => e.slice(0, 3)},
                    axisPointer: {type: "shadow"},
                ...
                yAxis: [{
                    ...
                    max: 250,
                    interval: 50,
                    axisLabel: {color: e("quaternary-color"), formatter: "{value} ml"},
                    ...
                    max: 25,
                    interval: 5,
                    axisLabel: {color: e("quaternary-color"), formatter: "{value} °C"},
                    splitLine: {show: !0, lineStyle: {color: e("secondary-bg")}}
                }],
                series: [{
                    name: "Evaporation",
    ...
    const barWaterFallChartInit = () => {
        const {getColor: t, getData: r} = window.phoenix.utils,
            ...
            a = ["2021-06-05", "2021-06-06", "2021-06-07", "2021-06-08", "2021-06-09", "2021-06-10", "2021-06-11", "2021-06-12", "2021-06-13", "2021-06-14", "2021-06-15"];
        if (o) {
            const e = r(o, "echarts"), i = window.echarts.init(o);
            echartSetOption(i, e, (() => ({
                legend: {data: ["Expenditure", "Income"], textStyle: {color: t("quaternary-color")}},
                tooltip: {
                    trigger: "axis",
                    padding: [7, 10],
                    backgroundColor: t("body-highlight-bg"),
                ...
                series: [{
                    ...
                    type: "bar",
                    stack: "Total",
                    label: {show: !0, position: "bottom", color: t("quaternary-color")},
    ...
    const barTimelineChartInit = () => {
        ...
        if (o.dataTI = i({
            ...
            const i = a(e, "echarts"), l = window.echarts.init(e);
            echartSetOption(l, i, (() => ({
                baseOption: {
                    timeline: {
                        axisType: "category",
        ...
        if (e) {
            ...
            echartSetOption(r, a, (() => ({
                ...
                xAxis: {
                    ...
                    max: "dataMax",
                    boundaryGap: !0,
                    axisPointer: {lineStyle: {color: o("tertiary-bg"), type: "dashed"}},
                    axisLine: {lineStyle: {color: o("tertiary-bg"), type: "solid"}},
                    axisTick: {show: !1},
                    axisLabel: {
                        color: o("quaternary-color"),
                ...
                yAxis: {
                    ...
                    splitLine: {lineStyle: {color: o("secondary-bg"), type: "dashed"}},
                    boundaryGap: !1,
                    axisLabel: {show: !0, color: o("quaternary-color"), margin: 15, fontWeight: 500},
                    axisTick: {show: !1},
                    axisLine: {show: !1}
                },
                series: [{
    ...
    const candlestickMixedChartInit = () => {
        ...
        if (o) {
            ...
            echartSetOption(s, i, (() => ({
                animation: !1,
                color: a,
                legend: {top: 0, data: ["MA1", "MA5", "Volume"], textStyle: {color: e("quaternary-color")}},
                tooltip: {
                    trigger: "axis",
                    padding: [7, 10],
                    backgroundColor: e("body-highlight-bg"),
                ...
                xAxis: [{
                    ...
                    boundaryGap: !1,
                    axisLine: {lineStyle: {color: e("tertiary-bg")}},
                    axisLabel: {color: e("quaternary-color"), formatter: e => window.dayjs(e).format("MMM DD")},
                    min: "dataMin",
                    max: "dataMax",
                    axisPointer: {show: !0}
                }, {
    ...
    const mapUSAInit = () => {
        const {getColor: a, getData: e} = window.phoenix.utils, n = document.querySelector(".echart-map-usa-example"),
            o = [{name: "Alabama", value: 4822023}, {name: "Alaska", value: 731449}, {
                name: "Arizona",
                value: 6553255
        ...
        if (n) {
            const l = e(n, "echarts"), t = window.echarts.init(n);
            echartSetOption(t, l, (() => ({
                tooltip: {
                    trigger: "item",
                    padding: [7, 10],
    ...
    const basicScatterChartInit = () => {
        ...
        if (e) {
            const r = o(e, "echarts"), i = window.echarts.init(e);
            echartSetOption(i, r, (() => ({
                tooltip: {
                    trigger: "item",
                    axisPointer: {type: "none"},
    ...
    const bubbleChartInit = () => {
        ...
        if (o) {
            const i = a(o, "echarts"), l = window.echarts.init(o);
            echartSetOption(l, i, (() => ({
                title: {
                ...
                legend: {right: 0, top: "10%", data: ["1990", "2015"], textStyle: {color: t("tertiary-color")}},
                xAxis: {
                    axisLabel: {color: t("quaternary-color"), formatter: t => t / 1e3 + "k"},
                    axisLine: {show: !0, lineStyle: {color: t("tertiary-bg")}},
                    splitLine: {show: !0, lineStyle: {color: t("secondary-bg")}}
                },
                yAxis: {
                ...
                series: [{
                    ...
                    emphasis: {
                        focus: "series",
                        label: {color: t("tertiary-color"), show: !0, formatter: t => t.data[3], position: "top"}
                    },
                    itemStyle: {color: e(t("primary"), .7)}
                }, {
                    name: "2015",
                    data: r[1],
                    type: "scatter",
                    ...
                    emphasis: {
                        focus: "series",
                        label: {color: t("quaternary-color"), show: !0, formatter: t => t.data[3], position: "top"}
                    },
                    itemStyle: {color: e(t("warning"), .7)}
                }],
    ...
    const quartetScatterChartInit = () => {
        const {getColor: t, getData: e} = window.phoenix.utils,
            ...
            o = () => ({
                ...
                animation: !1,
                label: {formatter: "y = 0.5 * x + 3", align: "right", color: t("tertiary-color"), fontWeight: 600},
                ...
                width: "38%",
                height: "38%"
            }], l = [{left: 6, right: 7, top: "4%", height: "20%"}, {
                left: 6,
                right: 7,
                top: "29%",
                height: "20%"
        ...
        if (i) {
            const x = e(i, "echarts"), s = window.echarts.init(i);
            echartSetOption(s, x, (() => ({
                ...
                title: {text: "Anscombe's quartet", left: "center", top: 0, textStyle: {color: t("tertiary-color")}},
    ...
    const singleAxisScatterChartInit = () => {
        const {getColor: t, getData: a, getRandomNumber: e} = window.phoenix.utils,
            o = document.querySelector(".echart-single-axis-scatter-chart-example"),
            r = ["12am", "1am", "2am", "3am", "4am", "5am", "6am", "7am", "8am", "9am", "10am", "11am", "12pm", "1pm", "2pm", "3pm", "4pm", "5pm", "6pm", "7pm", "8pm", "9pm", "10pm", "11pm"],
            i = ["Saturday", "Friday", "Thursday", "Wednesday", "Tuesday", "Monday", "Sunday"], n = [];
        for (let t = 0; t < 7; t += 1) for (let a = 0; a < 24; a += 1) n.push([a, t, e(0, 10)]);
        if (o) {
            const e = a(o, "echarts"), l = window.echarts.init(o);
            echartSetOption(l, e, (() => ({
                tooltip: {
                    trigger: "item",
                    axisPointer: {type: "none"},
    ...
    const doughnutChartInit = () => {
        ...
        if (o) {
            const r = t(o, "echarts"), i = window.echarts.init(o);
            echartSetOption(i, r, (() => ({
                legend: {left: "left", textStyle: {color: e("tertiary-color")}},
                series: [{
                    type: "pie",
        ...
        if (o) {
            ...
            echartSetOption(i, r, (() => ({
                ...
                series: [{
                    ...
                    avoidLabelOverlap: !1,
                    itemStyle: {borderRadius: 10, borderColor: e("body-highlight-bg"), borderWidth: 2},
                    label: {show: !1, position: "center"},
                    labelLine: {show: !1},
    ...
    const pieMultipleChartInit = () => {
        const {getColor: e, getData: t} = window.phoenix.utils,
            ...
            }], o = [{value: 1048, name: "Facebook", itemStyle: {color: e("primary")}}, {
                value: 735,
                name: "Youtube",
                itemStyle: {color: e("danger")}
    ...
    const pieLabelAlignChartInit = () => {
        const {getColor: e, getData: t, rgbaColor: i} = window.phoenix.utils,
            ...
            o = [{value: 850, name: "Starter", itemStyle: {color: i(e("primary"), .5)}}, {
                value: 750,
                name: "Starter Pro",
                itemStyle: {color: e("danger")}
                ...
                itemStyle: {color: i(e("warning"), .8)}
            }, {value: 471, name: "Premium", itemStyle: {color: e("success")}}, {
                value: 524,
                name: "Platinum",
                itemStyle: {color: e("info")}
            }, {value: 200, name: "Platinum Pro", itemStyle: {color: i(e("primary"), .5)}}];
        if (r) {
            const i = t(r, "echarts"), l = window.echarts.init(r);
            echartSetOption(l, i, (() => ({
                title: [{
                ...
                tooltip: {
                    ...
                    position(e, ...t) {
                        if (window.innerWidth <= 540) {
                            const i = t[1].offsetHeight, r = {top: e[1] - i - 20};
                ...
                series: [{
                    ...
                    center: ["50%", "50%"],
                    data: o,
                    label: {position: "outer", alignTo: "labelLine", bleedMargin: 5, color: e("tertiary-color")},
                    left: "5%",
                    right: "5%",
                    top: 0,
                    bottom: 0
    ...
    const pieEdgeAlignChartInit = () => {
        ...
        if (i) {
            const r = t(i, "echarts"), l = window.echarts.init(i);
            echartSetOption(l, r, (() => ({
                title: [{
                ...
                tooltip: {
                    ...
                    position(e, ...t) {
                        if (window.innerWidth <= 540) {
                            const r = t[1].offsetHeight, i = {top: e[1] - r - 20};
                ...
                series: [{
                    ...
                    center: ["50%", "50%"],
                    data: o,
                    label: {position: "outer", alignTo: "edge", margin: 20, color: e("tertiary-color")},
                    left: "5%",
                    right: "5%",
                    top: 0,
                    bottom: 0
        ...
        if (r) {
            ...
            echartSetOption(a, o, (() => ({
                ...
                series: [{
                    ...
                    data: [{value: 50, name: "SCORE", detail: {color: t("tertiary-color")}}]
                }]
            })));
        }
    };
    ...
    const gaugeProgressChartInit = () => {
        ...
        if (r) {
            const a = o(r, "echarts"), i = window.echarts.init(r);
            echartSetOption(i, a, (() => ({
                tooltip: {
                    trigger: "axis",
                    padding: [7, 10],
                ...
                series: [{
                    ...
                    axisLine: {lineStyle: {width: 18, color: [[1, e("secondary-bg")]]}},
                    axisTick: {show: !1},
                    splitLine: {lineStyle: {width: 2, color: e("quaternary-color")}},
                    ...
                    data: [{value: 70, detail: {fontSize: 30, color: e("quaternary-color"), offsetCenter: [0, "40%"]}}]
                }]
            })));
        }
    };
        ...
        if (o) {
            ...
            echartSetOption(i, r, (() => ({
                ...
                series: [{
                    ...
                    axisLine: {lineStyle: {width: 18, color: [[1, t("secondary-bg")]]}},
    ...
    const gaugeMultiRingChartInit = () => {
        ...
        if (i) {
            const o = t(i, "echarts"), a = window.echarts.init(i);
            echartSetOption(a, o, (() => ({
                series: [{
                    type: "gauge",
                    startAngle: 90,
                    ...
                    axisLine: {lineStyle: {width: 8, color: [[1, e("secondary-bg")]]}},
                    splitLine: {show: !1},
                    axisTick: {show: !1},
                    axisLabel: {show: !1},
                    data: [79],
        ...
        if (o) {
            ...
            echartSetOption(i, r, (() => ({
                ...
                series: [{
                    ...
                    axisLine: {roundCap: !0, lineStyle: {color: [[1, e("secondary-bg")]]}},
                    axisTick: {show: !1},
                    splitLine: {lineStyle: {width: 2, color: e("quaternary-color")}},
                    axisLabel: {distance: 25, color: e("quaternary-color")},
                    data: [{
    ...
    const radarChartInit = () => {
        ...
        if (a) {
            const o = t(a, "echarts"), i = window.echarts.init(a);
            echartSetOption(i, o, (() => ({
                legend: {
                    orient: "vertical",
                    left: "left",
                ...
                tooltip: {
                    ...
                    position(e, ...t) {
                        if (window.innerWidth <= 540) {
                            const r = t[1].offsetHeight, a = {top: e[1] - r - 20};
    ...
    const radarCustomizedChartInit = () => {
        const {getColor: e, getData: t, rgbaColor: r} = window.phoenix.utils,
            a = document.querySelector(".echart-radar-customized-chart-example"), o = e => {
                const t = [["Marketing", "Sales", "Dev", "Support", "Tech", "Admin"], ["Language", "Math", "English", "Physics", "Chemistry", "Biology"]],
                    r = e.seriesIndex;
        ...
        if (a) {
            const n = t(a, "echarts"), i = window.echarts.init(a);
            echartSetOption(i, n, (() => ({
                legend: {orient: "vertical", left: "left", textStyle: {color: e("tertiary-color")}},
                tooltip: {
                    trigger: "item",
                    padding: [7, 10],
                    backgroundColor: e("body-highlight-bg"),
                ...
                radar: [{
                    ...
                    name: {formatter: "{value}", textStyle: {color: e("tertiary-color")}},
                    splitLine: {lineStyle: {color: r(e("tertiary-color"))}}
                }, {
                ...
                series: [{
                    ...
                    data: [{
                        ...
                        label: {show: !0, formatter: e => e.value, color: e("tertiary-color")}
                    }, {
    ...
    const heatmapChartInit = () => {
        const {getColor: t, getData: o, rgbaColor: a, getRandomNumber: e} = window.phoenix.utils,
        ...
        for (let t = 0; t < 7; t += 1) for (let o = 0; o < 12; o += 1) s.push([o, t, e(5, 12)]);
        if (r) {
            const e = o(r, "echarts"), n = window.echarts.init(r);
            echartSetOption(n, e, (() => ({
                tooltip: {
                    position: "top",
                    padding: [7, 10],
                ...
                yAxis: {
                    type: "category",
                    data: l,
                    axisLabel: {formatter: t => t.substring(0, 3), color: t("quaternary-color")},
                    splitArea: {show: !0},
                    axisLine: {show: !0, lineStyle: {color: t("quaternary-color")}}
                },
                visualMap: {
                    ...
                    inRange: {color: [a(t("primary"), 1), a(t("info"), 1), a(t("success"), 1)]}
                },
                series: [{
                    type: "heatmap",
                    data: s,
                    label: {show: !0},
                    emphasis: {itemStyle: {shadowBlur: 10, shadowColor: a(t("black"), .5)}}
                }]
            })));
        }
    };
    ...
    const heatmapSingleSeriesChartInit = () => {
        const {getColor: t, getData: o, rgbaColor: e, getRandomNumber: a} = window.phoenix.utils,
            r = document.querySelector(".echart-heatmap-single-series-chart-example"),
            i = ["12a", "2a", "4a", "6a", "8a", "10a", "12p", "2p", "4p", "6p", "8p", "10p"],
            l = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"], s = [];
        for (let t = 0; t < 7; t += 1) for (let o = 0; o < 12; o += 1) s.push([o, t, a(1, 12)]);
        if (r) {
            const a = o(r, "echarts"), n = window.echarts.init(r);
            echartSetOption(n, a, (() => ({
