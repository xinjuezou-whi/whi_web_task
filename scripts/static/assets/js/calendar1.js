(function (factory) {
    ...
    const appCalendarInit = () => {
        const e = "#addEventForm", t = "#addEventModal", a = "#appCalendar", n = ".calendar-title", r = ".calendar-day",
            o = ".calendar-date", l = "[data-fc-view]", c = "[data-event]", d = "#eventDetailsModal",
            u = "#eventDetailsModal .modal-content", i = '#addEventModal [name="startDate"]', s = '[name="title"]',
            m = "click", v = "shown.bs.modal", y = "submit", p = "event", D = "fc-view",
            g = events.reduce(((e, t) => t.schedules ? e.concat(t.schedules.concat(t)) : e.concat(t)), []);
        (() => {
            const e = new Date, t = e.toLocaleString("en-US", {month: "short"}), a = e.getDate(), n = e.getDay(),
                l = `${a}  ${t},  ${e.getFullYear()}`;
        ...
        const S = e => {
                ...
                if ("timeGridWeek" === t) {
                    const t = e.dateProfile.currentRange.start, a = t.toLocaleString("en-US", {month: "short"}),
                        r = t.getDate(), o = e.dateProfile.currentRange.end,
                        l = o.toLocaleString("en-US", {month: "short"}), c = o.getDate();
                    document.querySelector(n).textContent = `${a} ${r} - ${l} ${c}`;
                } else document.querySelector(n).textContent = e.viewTitle;
            }, f = document.querySelector(a), h = document.querySelector(e), w = document.querySelector(t),
        ...
        if (f) {
            ...
            S(e.currentData), document.querySelectorAll(c).forEach((t => {
                ...
                t.addEventListener(m, (t => {
                    t.preventDefault();
                    const a = t.currentTarget;
                    e.changeView(getData(a, D)), S(e.currentData);
                }));
